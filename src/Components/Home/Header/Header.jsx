...
const Header = () => {
    return (
        <div className='font-righteous'>
            ...
            <div className='absolute -mb-16 space-y-4 w-3/5 text-white items-center md:p-10 h-[85vh] mt-[92px] lg:mt-[80px] md:pt-40  left-0 top-0 bg-gradient-to-r from-[#7f7d7d] to-[rgba(21,21,21,0)]'>
                <h1 className=' font-bold text-xl md:text-5xl pl-6 mt-20 md:mt-0 md:pl-20 w-full '>Tasker: <span className='text-xl md:text-4xl'>Master Your Day</span></h1>
